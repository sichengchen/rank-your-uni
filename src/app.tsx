    ...
    <TooltipProvider>
      <main className="min-h-screen bg-background text-foreground">
        <div className="mx-auto flex min-h-screen max-w-6xl flex-col gap-5 px-4 py-5 sm:px-6 lg:h-screen lg:min-h-0 lg:overflow-hidden lg:px-8">
          ...
          <aside className="lg:min-h-0 lg:flex-1 lg:basis-0">
            <Card className="h-[min(520px,calc(100vh-2.5rem))] gap-0 border border-border py-0 ring-0 lg:h-full lg:min-h-0">
              ...
              <CardContent className="min-h-0 flex-1 overflow-y-auto px-4 pb-6 pr-5 pt-3 [scrollbar-gutter:stable] sm:px-5 sm:pr-6">
