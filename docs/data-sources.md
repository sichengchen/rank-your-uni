...
```text
src/data/universities-2026.json
```

The dataset contains source metadata, source-specific rank chips, profile URLs when available, and a normalized union of university records.
